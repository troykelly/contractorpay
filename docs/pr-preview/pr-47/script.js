...
(function () {
  ...
  async function calculate() {
    ...
    if (hasHecsCheckbox && hasHecsCheckbox.checked) {
      fteRi = calcRepaymentIncome(taxableIncome, superRate);
      periodRi = calcRepaymentIncome(periodIncome, superRate);
      const basis = taxableIncome > 0 ? taxableIncome : periodIncome;
      updateRepaymentIncome(basis, fy, superRate);
